        ...
        <div class="card-body">
            <form action="{{ route('projects.update', $project->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-outline" data-mdb-input-init>
                        <input type="date" name="deadline" id="deadline" value="{{ old('deadline', $project->deadline) }}" class="form-control @error('deadline') is-invalid @enderror">
                    </div>
                ...
                <div class="text-end">
                    ...
                    <button type="submit" class="btn btn-primary text-capitalize shadow-none">Update Project</button>
                </div>
            </form>
        </div>
    </div>
